 ...
 */
function createKanbanLeadItems(order, color) {
    let knbn_column = kanbanTemplatesGenerateLeadItems({ item_get: 'get-knbn-lead-column' });
...
function kanbanTemplatesGenerateLeadItems(options = {}) {
    switch (options.item_get) {
        ...
        case 'get-knbn-lead-item':
            return $(`
                <li data-id = "${options.id}" data-pos = "${options.position}" class = "knbn-lead-item" style = "border-left-color: ${options.border_color} ">
                    <div class = "lead-cont">
