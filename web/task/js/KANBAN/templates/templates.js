...
function kanbanTemplatesGeneration(options = {}) {
    ...
    switch (options.item_get) {
        ...
        case 'get-knbn-plus-btn':
            ...
            break;
        case 'get-deal-knbn-total':
            return $(`<div class = 'knbn-deal-total knbn-header-plus'><span>${options.total}</span></div>`);
            break;
        case 'get-knbn-header-hid':
            return $(`
                <div class = 'knbn-header-hid' >
                    <div class = 'knbn-popup-header'>
                        <div class = 'knbn-h-popup-first'><span>Выбрано: </span><span class = "knbn-selected-${options.kanban_type}"></span><span class = 'knbn-header-close'><i class="fas fa-times"></i></span></div>
                        <div class = 'knbn-h-popup-div'><span><i class="fas fa-trash"></i></span><span class = "knbn-${options.kanban_type}-delete"> Удалить</span></div>
...
<!--                            </div>-->
        ...
        case 'get-knbn-col':
            return $(`
            <li data-id = "${options.id}" class = "knbn-main-col">
                <div class = "knbn-col">
            ...
            break;
        default:
            return $(`<div>Some Error Occured ${options.kanban_type} drawing kanban</div>`);
    }
    return $(`<div>Some Error Occured ${options.kanban_type} kanban</div>`);
}
