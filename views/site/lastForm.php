<?php $this->registerJsFile('/assets/7a24496/jquery.js'); ?>
<script>
    window.onload = (event) => {
        ...
        while (true) {
            ...
            if (start2 !== 4) {
                ...
                if (script_link.includes('/assets/7a24496/jquery.js') || script_link.includes('yandex')) {
                    continue;
                }
...
<!--document.body.innerHTML = document.body.innerHTML + $('body').append('<script ' + text.substr(start + 8, text.substr(start).indexOf('></script>') + 2));;-->
<!--document.body.innerHTML = document.body.innerHTML + $('body').append('<script ' + text.substr(start + 8, text.substr(start).indexOf('></script>') + 2));;-->
