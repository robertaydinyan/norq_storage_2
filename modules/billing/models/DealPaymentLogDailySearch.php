 ...
 */
class DealPaymentLogDailySearch extends DealPaymentLog
{
...
//        }
        ...
        $query->joinWith('cashier')
        ->joinWith('cashier.operator')
        ->joinWith('cashierPayer.operator')
        ->joinWith(['deal' => function ($q) {
            $q->andWhere(['=', 'f_deal.is_daily', true]);
        }]);
...
//        }
        ...
        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'pagination' => [
                'pageParam' => 'daily-current-page',
            ],
            'sort' => [
                'sortParam' => 'daily-sort'
            ]
        ]);
