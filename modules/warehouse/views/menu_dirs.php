<nav id="w4" class="main-header navbar navbar-expand bg-white navbar-light border-bottom">
    <div id="w3-collapse" class="collapse navbar-collapse">
        <ul id="w5" class="navbar-nav w-100 nav">
            ...
            <li class="nav-item"><a class="nav-link" href="/warehouse/currency?lang=<?php echo \Yii::$app->language; ?>"><?php echo Yii::t('app', 'Currency'); ?></a></li>
...
-->          <!--  <li class="nav-item"><a class="nav-link" href="/warehouse/warehouse-types?lang=<?php /*echo \Yii::$app->language; */?>"><?php /*echo Yii::t('app', 'Warehouse types'); */?></a></li>-->
            ...
            <li class="nav-item"><a class="nav-link" href="/warehouse/manufacturer?lang=<?php echo \Yii::$app->language; ?>"><?php echo Yii::t('app', 'Manufacturers'); ?></a></li>
        </ul>
    </div>
</nav>
