...
$this->title = Yii::t('app', 'In the matter of change') . ': ' . $model->id;
...
<div class="shipping-request-create group-product-index">
    ...
    <h5 style="padding: 20px;"><?= Html::encode($this->title) ?><a href=""><i class="fa fa-star-o ml-4" style="font-size: 30px"></i></a></h5>
