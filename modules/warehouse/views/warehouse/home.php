                            ...
                            if (!empty($products)) {
                                foreach ($products as $product_ => $product_val) {
                                    if ($product_val['pcount']) {
                                        echo '<a target="_blank" href="/warehouse/warehouse/view?id=' . $product_val['wid'] . '&lang=">' . $product_val['wname'] . '-' . $product_val['name'] . '( ' . $product_val['pcount'] . $product_val['qty_type'] . ')</a><br>';
                                    }
                                }
                            }
                        } ?>
        ...
        <div class="warehouse-home-item mb-3">
            <div class="widget widget-card-two">
                <div class="widget-content">
                    ...
                    <div class="card-bottom-section mt-5">
                        <div><a href="/warehouse/shipping-request/documents"
                                class="btn  text-white see mb-3"><?= Yii::t('app', 'View') ?></a></div>
                    </div>
                </div>
            </div>
        ...
        <div class="warehouse-home-item mb-3">
            <div class="widget widget-card-two">
                <div class="widget-content">
                    ...
                    <div class="card-bottom-section mt-5">
                        <div><a href="/warehouse/complectation"
                                class="btn  text-white see mb-3"><?= Yii::t('app', 'View') ?></a></div>
                    </div>
                </div>
            </div>
        ...
        <div class="warehouse-home-item mb-3">
            <div class="widget widget-card-two">
                <div class="widget-content">
                    ...
                    <div class="card-bottom-section mt-5">
                        <div><a href="/warehouse/payments-log"
                                class="btn  text-white see mb-3"><?= Yii::t('app', 'View') ?></a></div>
                    </div>
                </div>
            </div>
    ...
    <div class="warehouse-home-item mb-3">
        <div class="widget widget-card-two">
            <div class="widget-content">
                ...
                <!--                </div>-->
                <div class="card-bottom-section mt-5">
                    <div><a href="/notifications" class="btn  text-white see mb-3"><?= Yii::t('app', 'View') ?></a>
                    </div>
                </div>
            </div>
        </div>
