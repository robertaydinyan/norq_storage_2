...
$this->title = array(Yii::t('app', 'Vat'),'Vat');
...
$actions = [
    ...
    'buttons' => [
        'update' => function ($url, $model) {
            return \app\rbac\WarehouseRule::can('vat', 'update') ?
        ...
        'delete' => function ($url, $model) {
            return \app\rbac\WarehouseRule::can('vat', 'delete') ?
...
?>
<?php if(\app\rbac\WarehouseRule::can('vat', 'index')): ?>
<div class="vat-index">
    ...
    <div class="d-flex flex-wrap justify-content-between mt-3 mb-3">
        ...
        <div>
            <?php if(\app\rbac\WarehouseRule::can('vat', 'create')): ?>
            ...
            <button class="btn btn-primary mr-2 filter"  data-model="Vat"><i
