...
class ActionBar extends \yii\base\Widget
{
    ...
    {
        if (!isset(Yii::$app->i18n->translations['yii2/actionbar/*'])) {
            Yii::$app->i18n->translations['yii2/actionbar/*'] = [
                'class' => PhpMessageSource::className(),
                'sourceLanguage' => 'hy-HY',
                'basePath' => '@widgets/Actions/messages',
                'fileMap' => [
                    '@widgets/Actions/messages' => 'actionbar.php',
                ],
            ];
        }
    }
    ...
    {
        return Yii::t('yii2/actionbar/' . $category, $message, $params, $language);
    }
